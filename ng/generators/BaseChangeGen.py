...
class BaseChangeGen(AbstractNoiseGen):
    ...
    def description(**kwargs):
        return '{} changes to base {} the input element'.format(BaseChangeGen.name(), base)
    ...
    def int_udf(self, distribution):
        return F.udf(lambda elem: BaseChangeGen.base_change_generation(elem, distribution), StringType())
